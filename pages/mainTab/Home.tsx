      ...
      const asyncDataList: UserData[] = [
        { 
          ...
          goals: [
            ...
            {goalId: '3', title: '졸업작품 완성하기', icon: 'icon', d_day: 120, checklist: [
            ...
            {"goalId": "4", "title": "자격증 취득하기", "icon": "icon", "d_day": 200, checklist: [], 
